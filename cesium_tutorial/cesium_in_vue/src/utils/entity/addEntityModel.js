...
class addEntityModel {
    ...
    addEntity(position) {
        ...
        console.log(' this.option.radar ', option.radar, 'this.option.radarOption ', option.radarOption)
        ...
        if (this.option.radar) {
            ...
            this.addRadar({
                position: this.position,//curPos,
                HeadingPitchRoll: Cesium.Transforms.headingPitchRollQuaternion(this.curPos, this.headingPitchRoll)
            });
