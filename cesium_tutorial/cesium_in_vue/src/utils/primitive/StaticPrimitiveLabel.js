...
class StaticPrimitiveLabel {
    constructor(viewer, modelOption = {}, labelOption = {}) {
        ...
        this.label = null;
        this.line = null;
        // this.static = modelOption.static ? labelOption.static ? true : false : labelOption.static ? true : false;//暂定通过 modelOption 和 labelOption 一起判断 是否是 static，
        this.static = true;//默认是静态的，不需要进行更新的
    ...
    init() {
        ...
        console.log("this.label.position", this.label.position);
        ...
        console.log('%c [ this.line ]-127', 'font-size:13px; background:pink; color:#bf2c9f;', this.line)
...
export default StaticPrimitiveLabel