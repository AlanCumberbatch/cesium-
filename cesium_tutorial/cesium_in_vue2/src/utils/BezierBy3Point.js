...
function BezierBy3Point(p1, p2, p3, len = 100) {
  let points = [];
  ...
  // let h = Math.pow(p3[0]) + Math.pow(p3[0]);//  magnitude of p3.xy/p3.xy 的 模
  points = getBSRxyz(p1[0], p1[1], p2[0], p2[1], p3[2]);//定义好的曲线
