...
var factorial = ()=>import("./CesiumMath_factorial.js");
        ...
        for (i = 1; i < zIndicesLength; i++) {
            ...
            for (j = 0; j < zIndicesLength - i; j++) {
                ...
                if (zn - zj <= 0) {
                    ...
                    numerator =
                        coefficients[s][i - 1][j + 1] -
                        coefficients[s][i - 1][j];
    ...
    for (var s = 0; s < yStride; s++) {
        ...
        for (var i = 1; i < zIndiceslength; i++) {
            ...
            for (j = 0; j < zIndiceslength - i; j++) {
                ...
                if (zn - zj <= 0) {
                    index =
                        zIndices[j] * yStride * (inputOrder + 1) +
                        yStride * i +
                        s;
                    numerator = yTable[index];
...
HermitePolynomialApproximation.interpolateOrderZero(
	x,
	xTable,
	yTable,
	yStride,
